        ...
        loginForm.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                if (error.code === 'auth/user-not-found' || error.code === 'auth/wrong-password' || error.code === 'auth/invalid-credential') {
                    document.getElementById("general-error").textContent = "Email ou senha inválidos. Por favor, verifique suas credenciais.";
                } else {
                    document.getElementById("general-error").textContent = "Ocorreu um erro ao tentar logar. Tente novamente mais tarde.";
                }
            }
        });
    }
